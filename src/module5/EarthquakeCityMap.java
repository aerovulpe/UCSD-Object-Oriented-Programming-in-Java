...
public class EarthquakeCityMap extends PApplet {
	...
	private List<CommonMarker> cityMarkers;
	...
	//
	@SafeVarargs
	private final void selectMarkerIfHover(List<CommonMarker>... markers) {
		// Implement this method
		OLOOP: for (List<CommonMarker> markerList : markers)
	...
	@SafeVarargs
	private final void selectMarkerIfClicked(List<CommonMarker>... markers) {
	...
	private void showMarkers() {
		for (CommonMarker m : quakeMarkers)
			m.setHidden(false);
		for (CommonMarker m : cityMarkers)
			m.setHidden(false);
	}
	...
	private void clickedMarkerHelper(CommonMarker markerSelected) {
		...
		if (markerSelected instanceof EarthquakeMarker) {
			for (CommonMarker marker : quakeMarkers)
				marker.setHidden(true);

			double threatDistance = ((EarthquakeMarker) markerSelected).threatCircle();
			for (CommonMarker marker : cityMarkers)
